...
contract ERC20Token {
    ...
    */	
    ...
    constructor(string _name, string _symbol, uint256 _supply, uint8 _decimals) public {
        owner = msg.sender;
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
        totalSupply_ = _supply.mul(uint256(10) ** _decimals);
